...
type LayoutRouteId = RouteId | "/begrijpen" | "/begrijpen/[slug]" | "/begrijpen/step1" | "/begrijpen/step2" | "/begrijpen/step3"
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/begrijpen/+page.server.js').load>>>>>>;
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/begrijpen/+layout.server.js').load>>>>>>;
